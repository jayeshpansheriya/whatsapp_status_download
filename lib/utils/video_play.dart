...
import 'package:whatsapp_download/utils/video_controller.dart';

String vpath = "/storage/emulated/0/";
    ...
    return Scaffold(
      ...
      floatingActionButton: new FloatingActionButton(
          ...
          onPressed: () async {
            ...
            if (!Directory("${vpath}/wa_status_saver/Videos")
                .existsSync()) {
              Directory("${vpath}/wa_status_saver/Videos")
                  .createSync(recursive: true);
            }
            String path = directory.path;
            String curDate = DateTime.now().toString();
            String newFileName =
                "$vpath/wa_status_saver/Videos/VIDEO-$curDate.mp4";
            print(newFileName);
